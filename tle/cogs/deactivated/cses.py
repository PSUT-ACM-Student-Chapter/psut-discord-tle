...
class CSES(commands.Cog):
    ...
    @commands.hybrid_command(description='Shows compiled CSES leaderboard', usage='[handles...]')
    ...
    @commands.hybrid_command(description='Force update the CSES leaderboard')
